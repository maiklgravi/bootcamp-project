...
<body>
    <div class="card"><template todo-card-template>
        <div class="col mb-5">
            <div class= "h-100" id="product" >
                <!-- Product image-->
                ...
                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    <div class="text-center">
                        <button class="add-to-cart btn btn-outline-dark mt-auto" href="#"  onclick="addToCart(id)" >Add to cart</button>
                    </div>
                </div>
            </div>
        </div>
